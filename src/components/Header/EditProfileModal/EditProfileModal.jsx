...
import { selectUser, selectTempAvatarUrl } from '../../../redux/user/selectors';
import { setTempAvatarUrl } from '../../../redux/user/slice';
...
const EditProfileModal = ({ isModalOpen, closeModal }) => {
	...
	const handleFormSubmit = (values) => {
		...
		if (tempAvatarUrl) {
			updatedProfile.avatar = tempAvatarUrl;
		}
	...
	const handleAvatarChange = (event) => {
		...
		if (file) {
			...
			dispatch(setTempAvatarUrl(newAvatarUrl));
		}
	};
